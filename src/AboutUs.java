...
public class AboutUs extends JFrame
{
    ...
    public AboutUs() {
        ...
        super("About Us - Jaipur National University");
        ...
        JLabel l6 = new JLabel("Developed By : Apoorv Varshney");
        l6.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l6.setBounds(70, 198, 600, 35);
        contentPane.add(l6);

        JLabel l7 = new JLabel("Roll Number - R22041");
        l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l7.setBounds(70, 260, 600, 34);
        contentPane.add(l7);

        JLabel l8 = new JLabel("Contact : apoorvvarshney04@gmail.com");
        ...
        JLabel l10 = new JLabel("Phone - +91 9045542154");
        l10.setFont(new Font("Trebuchet MS", Font.BOLD , 22));
        l10.setBounds(70, 360, 600, 34);
        contentPane.add(l10);
